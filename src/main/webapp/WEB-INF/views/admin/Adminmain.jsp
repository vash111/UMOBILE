					...
					<div class="nav">
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sb-sidenav-menu-nested nav accordion"
								...
								<nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link" href="/admin/memberList">회원관리</a> <a
										class="nav-link" href="/admin/adminList">관리자관리</a>
								</nav>
							</nav>
						</div>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-body">Umobile 시스템 관리자 페이지에 방문하신것을 환영합니다.</div>
					</div>
					<div class="card mb-4">
								...
								<tbody>
									...
									<c:forEach var="notice" items="${noticeList}">
										<tr>
											...
											<td><a href="/admin/read/${notice.nno}">${notice.title}</a>
											</td>
											<td>${notice.writer}</td>
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-chart-area me-1"></i> 고객 핸드폰 신청내역
						</div>
						<div class="card-body">
							<table class="table">
								<thead>
