			...
			<div class="rq-form">
				...
				<form action="login" method="post" onsubmit="return checkStuff()">
					...
					<button class="btns wid md-ripples ripples-light" type="submit"
						onclick="">로그인</button>
					<a
						href="https://kauth.kakao.com/oauth/authorize(client_id=${kakaoApiKey}, redirect_uri=${redirectUri}, response_type='code')}">
						<img src="${path}/resources/img/kakao_login_large_wide.png"> </a>
				</form>
